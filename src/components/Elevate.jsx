...
import pic from '../assets/mobile1.jpg';
import pic1 from '../assets/mobile2.jpg';
import pic2 from '../assets/mobile3.png';
      ...
      <div className={`flex flex-col h-full justify-center ${screenSize === 'mobile' ? 'order-2' : ''}`}>
        ...
        <div className='max-w-[1400px] mx-auto grid grid-cols-2 md:grid-cols-2 border-gray-600 py-8 px-4'>
          <div className='m-auto text-center'>
            <p className='italic text-center'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Expedita quaerat reprehenderit sunt placeat nostrum esse, excepturi, sit ipsa quisquam corrupti sapiente quae est rerum ducimus, ipsum neque.</p>
          </div>   
        </div>
      </div>
